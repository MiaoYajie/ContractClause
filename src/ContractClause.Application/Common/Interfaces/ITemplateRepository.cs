...
public interface ITemplateRepository
{
    ...
    Task<Template?> GetByExternalIdAsync(string externalId, CancellationToken ct = default);
    Task<Template?> GetByExternalIdForUpdateAsync(string externalId, CancellationToken ct = default);
